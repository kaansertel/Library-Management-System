...
.bttn{
    ...
    <body>
        ...
        <?php
            ...
            echo "<h1>Kategori Bilgileri</h1>";

            echo "<table border=1 id='tablo'>";
            echo "<tr>";
            echo "<th>Kategori No</th>";
            ...
            while($gelen=mysqli_fetch_array($cevap)){
                ...
                echo "<tr><td>".$gelen['KategoriNo']." </td>";
                echo "<td>".$gelen['KategoriAdi']."</td>";
                // sil linki olusturma
                echo "<td><a class='button' href=kategorisil.php?id=";
                echo $gelen['KategoriNo'];
                echo ">Sil</a></td>";
                // Guncellestirme
                echo "<td><a class='button' href=kategoriguncelle.php?id=";
                echo $gelen['KategoriNo'];
