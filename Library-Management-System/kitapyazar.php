...
if (isset($_POST["ISBN"],$_POST["YazarNo"])) {
    ...
    if ((!$cevap)) {
        ...
        echo "<h1 class='h_1'> Kitap  Yazar Bilgileri Veritabanına Eklendi. <br /> <br /> <br /><a class = 'btn' href= '_uyesayfasi.php'> Ana Sayfa</a>
        <a class = 'btn' href= 'kitap.php'> Geri dön </a> 
     </h1>";
    }
...
<!-- türkçe karakter destegi ayari -->
    <head>
        ...
        <title> | Kitap Yazar Ekleme | </title>
        <style>
            body{
