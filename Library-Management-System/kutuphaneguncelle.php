<html>
    <head>
      <link rel="stylesheet" type="text/css" href="kutuphaneguncelle.css"/>
       <title> | Kütüphane Güncelle | </title> 
...
// sorgu yazma
$sql = "SELECT * FROM Kutuphane WHERE KutuphaneNo=".$_GET['id'];
...
echo "<html>";
echo "<form class= 'form' action='kutuphaneguncelkaydet.php?id=$id&no=$no'";
//echo $_GET['id'];
//echo " &no=";
//echo $_GET['no'];
echo " method='POST'>";
...
echo " />";
echo "&nbsp; &nbsp;";
echo "<a  class='btn' href= 'kutuphaneislem.php'>IPTAL</a>";
echo "</form>";
echo "</html>";
