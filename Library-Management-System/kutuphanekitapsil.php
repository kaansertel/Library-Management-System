<html>
    <head>
        ...
        <title> | Kütüphane Kitap Sİl | </title>
        <style>
            body{
    ...
    <body>
        <?php
            ...
            // sorgu yazma
            $sql = "DELETE FROM KutuphaneKitap WHERE Kutuphane_Kitap_Gecis_Id=".$_GET['GecisId'];
            ...
            if ( (!$cevap)) {
                ...
                echo "<p class='h_1'> Kayıt silindi! </br><a class ='btn'href='kutuphanekitaplistele.php'>Listele</a>\n </p>";
