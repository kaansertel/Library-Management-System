    ...
    <body>
        ...
        <?php
            ...
            if (isset($_POST["YazarlarAdi"],$_POST["YazarlarSoyad"])) {
                ...
                //sorgu hazirlama
                $sql = "UPDATE Yazarlar SET YazarlarAdi='$YazarlarAdi', YazarlarSoyad='$YazarlarSoyad' WHERE YazarNo=".$_GET['id'];
                ...
                echo "<p class = 'h_1'> Kayıt Güncellendi!</br> <a class = 'btn' href='yazarislem.php'>Listele</a>\n </p>";
                }
                echo "</html>";
